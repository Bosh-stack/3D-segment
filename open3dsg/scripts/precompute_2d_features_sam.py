...
from open3dsg.data.open_dataset_sam import Open2D3DSGDataset
from open3dsg.scripts.feature_dumper_sam import FeatureDumper
...
def _parse_args():
    ...
    parser.add_argument("--clip_model", choices=["SAM"], default="SAM")
    ...
    parser.add_argument("--clip_batch", type=int, default=64,
                        help="Micro-batch size for CLIP/SAM image encodes")
...
def main_worker(fabric: Fabric, args):
    ...
    if args.load_node_features:
        ...
        obj_clip_model = (
            ...
            if node_hparams.get("node_model") and node_hparams["clip_model"] != "SAM"
